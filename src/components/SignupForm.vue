<template>
  <div class="min-h-screen bg-gray-50">
      ...
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between items-center h-16">
          ...
          <div class="flex items-center gap-4">
            ...
            <router-link to="/login" class="bg-blue-600 hover:bg-blue-700 text-white px-4 py-2 rounded-md font-medium">
              Sign In
            </router-link>
          </div>
        </div>
    ...
    <div class="flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
      ...
      <Form @submit="handleSubmit" class="mt-8 space-y-6" v-slot="{ errors }" role="form" aria-labelledby="signup-heading">
        <h2 id="signup-heading" class="sr-only">Create account form</h2>
        <div class="space-y-4">
          <div>
            ...
            />
            <ErrorMessage name="name" class="mt-1 text-sm text-red-600" role="alert" aria-live="polite" />
          </div>
          ...
          <div>
            ...
            />
            <ErrorMessage name="confirmPassword" class="mt-1 text-sm text-red-600" role="alert" aria-live="polite" />
          </div>
        </div>
        ...
        <div>
          <button
            ...
            :aria-label="authStore.isLoading ? 'Creating account, please wait' : 'Create your account'"
...
const validateConfirmPassword = (value, { form }) => {
  // Clear auth errors when user starts correcting input
  if (authStore.error) {
    authStore.clearError()
  }
